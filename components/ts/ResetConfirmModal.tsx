...
export const ResetConfirmModal = ({ visible, onConfirm, onClose }: Props) => {
  ...
  return (
    <SheetModal visible={visible} onClose={onClose} snapPoints={['38%']} index={0}>
      <BottomSheetView className="flex-1 px-6 pb-8 pt-4">
        ...
        <View className="flex-row gap-3">
          <Button variant="secondary" size="lg" className="flex-1" onPress={onClose}>
            <Text variant="label">Annulla</Text>
          </Button>
          <Button size="lg" className="flex-1 bg-red-500" onPress={handleConfirm}>
